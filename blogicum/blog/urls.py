...
urlpatterns = [
    ...
    path('postadd/', views.PostCreateView.as_view(), name='post_add'),
    ...
    path('posts/<int:post_id>/edit_comment/<int:comment_pk>/', views.CommentUpdateView.as_view(), name='edit_comment'),
    path('posts/<int:post_id>/delete_comment/<int:comment_pk>/', views.CommentDeleteView.as_view(), name='delete_comment'),
